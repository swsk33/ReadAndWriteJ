...
public class RandomReader {
	...
	public String ReadRandomlyStart(String filepathr,int start) throws Exception {		//从第几行开始随机读取文件后面的某行
		String result=null;
		Random r=new Random();
	...
	public String ReadRandomlyUntil(String filepathr,int linesa) throws Exception {		//从第一行开始随机读取文本文档前指定行数
		String result=null;
		Random r=new Random();
